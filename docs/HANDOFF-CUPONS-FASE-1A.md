...
`prevent_self_review=false` é intencional num repositório de operador único: trata-se de confirmação deliberada
e auditável pelo mesmo operador, não segregação de funções.
