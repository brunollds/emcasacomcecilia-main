...
const pages: Record<Locale, PageCopy> = {
  en: {
    locale: 'en', language: 'en', title: 'YesStyle Reward Code CECILIA010: Up to 5% Extra', description: 'Use the YesStyle reward code CECILIA010 at checkout to add 5% extra savings alongside active coupon codes.', eyebrow: 'YesStyle Reward Code', intro: 'CECILIA010 is a YesStyle Reward Code, not a regular coupon. Enter it in the dedicated Reward Code field to add up to 5% extra (5% on 1st order / 2% on returning orders).', updated: 'Verified', copy: 'Copy code', copied: 'Copied!', copyAria: 'Copy code CECILIA010', visit: 'Visit YesStyle', details: 'Code details', instructionsTitle: 'How to use CECILIA010', instructions: ['Copy CECILIA010.', 'Open YesStyle and add your products to the bag.', 'At checkout, enter the code in the Reward Code field.', 'Apply any active promo code separately in the Coupon Code field.', 'Check that both discounts appear before placing your order.'], note: 'Important: enter CECILIA010 in Reward Code, not Coupon Code.', faqTitle: 'Frequently asked questions', faqs: [{ question: 'Can I use CECILIA010 with a coupon?', answer: 'Yes. Use CECILIA010 in Reward Code and any eligible promotional code in Coupon Code.' }, { question: 'What discount does it offer?', answer: 'It adds 5% extra, subject to YesStyle’s active terms and eligible products.' }], transparency: 'This page contains affiliate links. If you visit YesStyle through our links or use the influencer code CECILIA010, we may earn a commission at no extra cost to you.'
  },
  es: {
    locale: 'es', language: 'es', title: 'Código de recompensa YesStyle CECILIA010: Hasta 5% extra', description: 'Usa el código de recompensa CECILIA010 en YesStyle para sumar un 5% extra junto con los cupones activos.', eyebrow: 'Código de recompensa YesStyle', intro: 'CECILIA010 es un código de recompensa, no un cupón tradicional. Úsalo en el campo Reward Code para sumar hasta un 5% extra (5% en 1ª compra / 2% en compras siguientes).', updated: 'Verificado', copy: 'Copiar código', copied: '¡Copiado!', copyAria: 'Copiar código CECILIA010', visit: 'Ir a YesStyle', details: 'Detalles del código', instructionsTitle: 'Cómo usar CECILIA010', instructions: ['Copia CECILIA010.', 'Entra a YesStyle y añade tus productos.', 'En el checkout, introdúcelo en Reward Code.', 'Usa por separado cualquier cupón activo en Coupon Code.', 'Comprueba ambos descuentos antes de pagar.'], note: 'Importante: CECILIA010 va en Reward Code, no en Coupon Code.', faqTitle: 'Preguntas frecuentes', faqs: [{ question: '¿Puedo usarlo con un cupón?', answer: 'Sí. Usa CECILIA010 en Reward Code y el cupón promocional en Coupon Code.' }, { question: '¿Qué descuento ofrece?', answer: 'Añade un 5% extra, según las condiciones vigentes de YesStyle.' }], transparency: 'Esta página contiene enlaces de afiliado. Si accedes a YesStyle mediante nuestros enlaces o usas el código de influencer CECILIA010, podemos recibir una comisión sin coste adicional para ti.'
  },
  fr: {
    locale: 'fr', language: 'fr', title: 'Code récompense YesStyle CECILIA010 : Jusqu’à 5 % en plus', description: 'Utilisez le code récompense CECILIA010 sur YesStyle pour ajouter 5 % de réduction aux coupons actifs.', eyebrow: 'Code récompense YesStyle', intro: 'CECILIA010 est un code récompense, et non un coupon classique. Saisissez-le dans le champ Reward Code pour ajouter jusqu’à 5 % (5 % 1ère commande / 2 % commandes suivantes).', updated: 'Vérifié', copy: 'Copier le code', copied: 'Copié !', copyAria: 'Copier le code CECILIA010', visit: 'Aller sur YesStyle', details: 'Détails du code', instructionsTitle: 'Comment utiliser CECILIA010', instructions: ['Copiez CECILIA010.', 'Ouvrez YesStyle et ajoutez vos produits.', 'Au paiement, saisissez-le dans Reward Code.', 'Ajoutez séparément tout coupon actif dans Coupon Code.', 'Vérifiez les deux réductions avant de payer.'], note: 'Important : CECILIA010 va dans Reward Code, pas dans Coupon Code.', faqTitle: 'Questions fréquentes', faqs: [{ question: 'Puis-je l’utiliser avec un coupon ?', answer: 'Oui. Utilisez CECILIA010 dans Reward Code et le coupon promotionnel dans Coupon Code.' }, { question: 'Quelle réduction offre-t-il ?', answer: 'Il ajoute 5 %, selon les conditions YesStyle en vigueur.' }], transparency: 'Cette page contient des liens affiliés. Si vous accédez à YesStyle via nos liens ou utilisez le code influenceur CECILIA010, nous pouvons recevoir une commission sans frais supplémentaires pour vous.'
  },
  de: {
    locale: 'de', language: 'de', title: 'YesStyle Reward Code CECILIA010: Bis zu 5 % extra', description: 'Nutze den YesStyle Reward Code CECILIA010 und erhalte zusätzlich 5 % neben aktiven Gutscheincodes.', eyebrow: 'YesStyle Reward Code', intro: 'CECILIA010 ist ein Reward Code, kein normaler Gutschein. Gib ihn im separaten Reward-Code-Feld ein, um bis zu 5 % extra zu erhalten (5 % bei Erstbestellung / 2 % bei Folgebestellungen).', updated: 'Verifiziert', copy: 'Code kopieren', copied: 'Kopiert!', copyAria: 'Code CECILIA010 kopieren', visit: 'Zu YesStyle', details: 'Code-Details', instructionsTitle: 'So verwendest du CECILIA010', instructions: ['Kopiere CECILIA010.', 'Öffne YesStyle und lege Produkte in den Warenkorb.', 'Gib den Code an der Kasse im Reward-Code-Feld ein.', 'Nutze aktive Gutscheincodes separat im Coupon-Code-Feld.', 'Prüfe beide Rabatte vor dem Bezahlen.'], note: 'Wichtig: CECILIA010 gehört in Reward Code, nicht in Coupon Code.', faqTitle: 'Häufige Fragen', faqs: [{ question: 'Kann ich den Code mit einem Gutschein nutzen?', answer: 'Ja. Nutze CECILIA010 im Reward-Code-Feld und den Aktionscode im Coupon-Code-Feld.' }, { question: 'Welchen Rabatt gibt es?', answer: 'Der Code fügt 5 % hinzu, gemäß den aktuellen YesStyle-Bedingungen.' }], transparency: 'Diese Seite enthält Affiliate-Links. Wenn du YesStyle über unsere Links besuchst oder den Influencer-Code CECILIA010 verwendest, können wir eine Provision erhalten, ohne dass dir zusätzliche Kosten entstehen.'
  },
...
export function getYesStyleMetadata(locale: string): Metadata {
  ...
  const canonicalMap: Record<string, string> = {
    'pt-BR': 'https://emcasacomcecilia.com/reviews/codigo-cecilia010-yesstyle-como-usar',
...
export function YesStyleCouponPage({ locale }: { locale: string }) {
  ...
  return <main className="min-h-screen bg-[#fef9f3] pb-24 lg:pb-0">
    ...
    <section className="px-4 pt-8"><div className="mx-auto max-w-5xl"><LanguageSwitcher currentLocale={page.locale} links={{ pt: '/reviews/codigo-cecilia010-yesstyle-como-usar', en: '/reviews/yesstyle-reward-code-coupon-cecilia010', es: '/reviews/codigo-de-recompensa-yesstyle-cupon-cecilia010', fr: '/reviews/code-recompense-yesstyle-cecilia010', de: '/reviews/yesstyle-reward-code-rabatt-cecilia010', ko: '/reviews/yesstyle-reward-code-cecilia010-ko', ja: '/reviews/yesstyle-reward-code-cecilia010-ja', 'zh-hant': '/reviews/yesstyle-reward-code-cecilia010-zh-hant', 'zh-hans': '/reviews/yesstyle-reward-code-cecilia010-zh-hans' }} /></div></section>
    <section className="px-4 py-12"><div className="mx-auto max-w-5xl rounded-[2rem] bg-[#111827] p-7 text-white shadow-large md:p-10"><p className="font-mono text-4xl font-black tracking-[.08em] md:text-6xl">CECILIA010</p><p className="mt-4 max-w-2xl text-white/85">{page.description}</p><div className="mt-7 flex flex-col gap-3 sm:flex-row"><CopyButton code="CECILIA010" label={page.copy} copiedLabel={page.copied} ariaLabel={page.copyAria} /><a href="https://ystyle.co/rQYQv" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-lg border border-white/30 px-4 py-2.5 text-sm font-semibold hover:bg-white/15">{page.visit}</a></div></div></section>
    <article className="bg-white px-4 py-14"><div className="mx-auto max-w-3xl"><h2 className="font-heading text-2xl font-black text-[#0f1419]">{page.details}</h2><dl className="mt-6 divide-y divide-black/8 rounded-2xl border border-black/8"><Detail label="Code" value="CECILIA010" /><Detail label="Discount" value="Up to 5% extra (5% for new customers / 2% for returning customers)" /><Detail label="Field" value="Reward Code" /></dl><h2 className="mt-12 font-heading text-2xl font-black text-[#0f1419]">{page.instructionsTitle}</h2><ol className="mt-4 list-decimal space-y-3 pl-6 text-[#0f1419]/78">{page.instructions.map((item) => <li key={item}>{item}</li>)}</ol><p className="mt-4 rounded-2xl border border-[#ff6b35]/25 bg-[#fff7ed] px-4 py-3 text-sm text-[#7c2d12]">{page.note}</p><h2 className="mt-12 font-heading text-2xl font-black text-[#0f1419]">{page.faqTitle}</h2><div className="mt-4"><FAQAccordion items={page.faqs} /></div><div className="mt-14 rounded-2xl bg-[#fef9f3] p-6 text-sm leading-relaxed text-[#0f1419]/68">{page.transparency}</div></div></article>
    <CouponBottomBar coupon="CECILIA010" cta={{ url: 'https://ystyle.co/rQYQv', label: page.visit }} locale={page.locale} />
  </main>;
}
